...
proc create_hier_cell_Sync { parentCell nameHier } {
  ...
  set AXI4Stream_IperDecod_0 [ create_bd_cell -type ip -vlnv DigiLAB:ip:AXI4Stream_IperDecoder:1.2 AXI4Stream_IperDecod_0 ]
  set_property -dict [ list \
  ...
  set BeltBus_NodeInserter_0 [ create_bd_cell -type ip -vlnv DigiLAB:ip:BeltBus_NodeInserter:2.3 BeltBus_NodeInserter_0 ]
  set_property -dict [ list \
   CONFIG.BIT_COARSE {8} \
