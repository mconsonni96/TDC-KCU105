...
-- Date        : Wed Dec  1 16:46:18 2021
-- Host        : mconsonni-All-Series running 64-bit Ubuntu 20.04.3 LTS
-- Command     : write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ design_1_AXI4Stream_UART_1_0_sim_netlist.vhdl
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART_Engine is
  ...
  signal rx_baud_counter : STD_LOGIC_VECTOR ( 6 downto 0 );
  signal \rx_baud_counter[2]_i_2_n_0\ : STD_LOGIC;
  signal \rx_baud_counter[6]_i_2_n_0\ : STD_LOGIC;
  signal rx_baud_counter_1 : STD_LOGIC_VECTOR ( 6 downto 0 );
  signal rx_baud_tick : STD_LOGIC;
  signal rx_baud_tick_reg_n_0 : STD_LOGIC;
  signal tx_baud_counter : STD_LOGIC_VECTOR ( 10 downto 0 );
  signal \tx_baud_counter[0]_i_1_n_0\ : STD_LOGIC;
  signal \tx_baud_counter[10]_i_2_n_0\ : STD_LOGIC;
  ...
  signal \tx_baud_counter[5]_i_2_n_0\ : STD_LOGIC;
  signal \tx_baud_counter[9]_i_2_n_0\ : STD_LOGIC;
  signal tx_baud_counter_0 : STD_LOGIC_VECTOR ( 10 downto 1 );
  ...
  attribute SOFT_HLUTNM of \rx_baud_counter[1]_i_1\ : label is "soft_lutpair87";
  attribute SOFT_HLUTNM of \rx_baud_counter[2]_i_1\ : label is "soft_lutpair87";
  attribute SOFT_HLUTNM of \rx_baud_counter[3]_i_1\ : label is "soft_lutpair92";
  attribute SOFT_HLUTNM of \rx_baud_counter[6]_i_2\ : label is "soft_lutpair92";
  attribute SOFT_HLUTNM of \tx_baud_counter[0]_i_1\ : label is "soft_lutpair90";
  attribute SOFT_HLUTNM of \tx_baud_counter[10]_i_1\ : label is "soft_lutpair90";
  attribute SOFT_HLUTNM of \tx_baud_counter[10]_i_2\ : label is "soft_lutpair85";
  attribute SOFT_HLUTNM of \tx_baud_counter[1]_i_1\ : label is "soft_lutpair96";
  attribute SOFT_HLUTNM of \tx_baud_counter[2]_i_1\ : label is "soft_lutpair86";
  attribute SOFT_HLUTNM of \tx_baud_counter[3]_i_1\ : label is "soft_lutpair86";
  attribute SOFT_HLUTNM of \tx_baud_counter[5]_i_1\ : label is "soft_lutpair96";
  attribute SOFT_HLUTNM of \tx_baud_counter[6]_i_1\ : label is "soft_lutpair91";
  attribute SOFT_HLUTNM of \tx_baud_counter[7]_i_1\ : label is "soft_lutpair91";
  attribute SOFT_HLUTNM of \tx_baud_counter[8]_i_1\ : label is "soft_lutpair85";
  attribute SOFT_HLUTNM of \uart_rx_bit_spacing[0]_i_1\ : label is "soft_lutpair93";
  attribute SOFT_HLUTNM of \uart_rx_bit_spacing[1]_i_1\ : label is "soft_lutpair93";
  ...
  attribute SOFT_HLUTNM of \uart_rx_count[0]_i_1\ : label is "soft_lutpair97";
  attribute SOFT_HLUTNM of \uart_rx_count[1]_i_1\ : label is "soft_lutpair97";
  ...
  attribute SOFT_HLUTNM of uart_rx_data_in_done_i_1 : label is "soft_lutpair94";
  attribute SOFT_HLUTNM of \uart_rx_filter[0]_i_1\ : label is "soft_lutpair95";
  attribute SOFT_HLUTNM of \uart_rx_filter[1]_i_2\ : label is "soft_lutpair95";
  attribute SOFT_HLUTNM of \uart_tx_count[0]_i_1\ : label is "soft_lutpair89";
  attribute SOFT_HLUTNM of \uart_tx_count[1]_i_1\ : label is "soft_lutpair88";
  attribute SOFT_HLUTNM of \uart_tx_count[2]_i_2\ : label is "soft_lutpair88";
  attribute SOFT_HLUTNM of uart_tx_data_i_2 : label is "soft_lutpair94";
  attribute KEEP : string;
  attribute KEEP of uart_tx_data_reg : label is "yes";
  attribute SOFT_HLUTNM of \uart_tx_data_vec[0]_i_1\ : label is "soft_lutpair89";
...
\rx_baud_counter[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00000000FFEFFFFF"
    )
        port map (
      I0 => rx_baud_counter(5),
      I1 => rx_baud_counter(3),
      I2 => rx_baud_counter(6),
      I3 => \rx_baud_counter[6]_i_2_n_0\,
      I4 => rx_baud_counter(4),
      I5 => rx_baud_counter(0),
      O => rx_baud_counter_1(0)
    );
\rx_baud_counter[1]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00FFDF00"
    )
        port map (
      I0 => rx_baud_counter(4),
      I1 => \rx_baud_counter[2]_i_2_n_0\,
      I2 => rx_baud_counter(2),
      I3 => rx_baud_counter(1),
      I4 => rx_baud_counter(0),
      O => rx_baud_counter_1(1)
    );
\rx_baud_counter[2]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"51FFAA00"
    )
        port map (
      ...
      I2 => \rx_baud_counter[2]_i_2_n_0\,
      I3 => rx_baud_counter(1),
      I4 => rx_baud_counter(2),
      O => rx_baud_counter_1(2)
    );
\rx_baud_counter[2]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EF"
    )
        port map (
...
\rx_baud_counter[4]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => rx_baud_counter(6),
      I3 => rx_baud_counter(3),
      I4 => rx_baud_counter(5),
      I5 => \rx_baud_counter[6]_i_2_n_0\,
      O => rx_baud_counter_1(4)
    );
\rx_baud_counter[5]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => rx_baud_counter(1),
      I2 => rx_baud_counter(4),
      I3 => rx_baud_counter(0),
      I4 => rx_baud_counter(3),
      I5 => rx_baud_counter(5),
      O => rx_baud_counter_1(5)
    );
\rx_baud_counter[6]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"CCCCCCCC6CC8CCCC"
    )
        port map (
      I0 => rx_baud_counter(0),
      I1 => rx_baud_counter(6),
      I2 => rx_baud_counter(5),
      I3 => rx_baud_counter(3),
      I4 => rx_baud_counter(4),
      I5 => \rx_baud_counter[6]_i_2_n_0\,
      O => rx_baud_counter_1(6)
    );
\rx_baud_counter[6]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
      I0 => rx_baud_counter(1),
      I1 => rx_baud_counter(2),
      O => \rx_baud_counter[6]_i_2_n_0\
    );
...
\rx_baud_counter_reg[5]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => clk_uart,
      CE => '1',
      D => rx_baud_counter_1(5),
      Q => rx_baud_counter(5),
      R => rst
    );
\rx_baud_counter_reg[6]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
      C => clk_uart,
      CE => '1',
      D => rx_baud_counter_1(6),
      Q => rx_baud_counter(6),
      R => rst
    );
rx_baud_tick_i_1: unisim.vcomponents.LUT6
    generic map(
...
\tx_baud_counter[10]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"6A00"
    )
        port map (
      I0 => tx_baud_counter(10),
      I1 => tx_baud_counter(9),
      I2 => \tx_baud_counter[10]_i_2_n_0\,
      I3 => \tx_baud_counter[10]_i_3_n_0\,
      O => tx_baud_counter_0(10)
    );
\tx_baud_counter[10]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
      ...
      O => \tx_baud_counter[10]_i_2_n_0\
    );
\tx_baud_counter[10]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFF7"
    )
        port map (
      I0 => tx_baud_counter(3),
      I1 => tx_baud_counter(10),
...
\tx_baud_counter[10]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
\tx_baud_counter[4]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => tx_baud_counter(2),
      I5 => \tx_baud_counter[10]_i_3_n_0\,
      O => tx_baud_counter_0(4)
    );
\tx_baud_counter[5]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"60"
    )
        port map (
      I0 => tx_baud_counter(5),
      I1 => \tx_baud_counter[5]_i_2_n_0\,
      I2 => \tx_baud_counter[10]_i_3_n_0\,
      O => tx_baud_counter_0(5)
    );
\tx_baud_counter[5]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"80000000"
    )
        port map (
      ...
      O => \tx_baud_counter[5]_i_2_n_0\
    );
\tx_baud_counter[6]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"60"
    )
        port map (
      ...
      I2 => \tx_baud_counter[10]_i_3_n_0\,
      O => tx_baud_counter_0(6)
    );
\tx_baud_counter[7]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"6A00"
    )
        port map (
      I0 => tx_baud_counter(7),
      I1 => tx_baud_counter(6),
      I2 => \tx_baud_counter[9]_i_2_n_0\,
      I3 => \tx_baud_counter[10]_i_3_n_0\,
      O => tx_baud_counter_0(7)
    );
...
\tx_baud_counter[9]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => tx_baud_counter(8),
      I2 => tx_baud_counter(6),
      I3 => \tx_baud_counter[9]_i_2_n_0\,
      I4 => tx_baud_counter(7),
      I5 => \tx_baud_counter[10]_i_3_n_0\,
      O => tx_baud_counter_0(9)
    );
...
\tx_baud_counter_reg[10]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => clk_uart,
      CE => '1',
      D => tx_baud_counter_0(10),
      Q => tx_baud_counter(10),
      R => rst
    );
...
\tx_baud_counter_reg[9]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => clk_uart,
      CE => '1',
      D => tx_baud_counter_0(9),
      Q => tx_baud_counter(9),
      R => rst
    );
tx_baud_tick_i_1: unisim.vcomponents.LUT6
    generic map(
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART_Manager is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \data_stream_in[0]_i_1\ : label is "soft_lutpair98";
  attribute SOFT_HLUTNM of \data_stream_in[1]_i_1\ : label is "soft_lutpair98";
  attribute SOFT_HLUTNM of \data_stream_in[2]_i_1\ : label is "soft_lutpair99";
  attribute SOFT_HLUTNM of \data_stream_in[3]_i_1\ : label is "soft_lutpair99";
  attribute SOFT_HLUTNM of \data_stream_in[4]_i_1\ : label is "soft_lutpair100";
  attribute SOFT_HLUTNM of \data_stream_in[5]_i_1\ : label is "soft_lutpair100";
  attribute SOFT_HLUTNM of \data_stream_in[6]_i_1\ : label is "soft_lutpair101";
  attribute SOFT_HLUTNM of \data_stream_in[7]_i_2\ : label is "soft_lutpair101";
begin
  rd_en <= \^rd_en\;
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXI4Stream_UART_v1_0 is
  ...
  attribute UART_CLOCK_FREQUENCY of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXI4Stream_UART_v1_0 : entity is 160000000;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXI4Stream_UART_v1_0 is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of FIFO_DATA_RX_i_1 : label is "soft_lutpair103";
  ...
  attribute SOFT_HLUTNM of FIFO_DATA_TX_i_2 : label is "soft_lutpair102";
  attribute SOFT_HLUTNM of m00_axis_rx_tvalid_INST_0 : label is "soft_lutpair103";
  attribute SOFT_HLUTNM of s00_axis_tx_tready_INST_0 : label is "soft_lutpair102";
begin
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute CHECK_LICENSE_TYPE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "design_1_AXI4Stream_UART_1_0,AXI4Stream_UART_v1_0,{}";
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute UART_CLOCK_FREQUENCY : integer;
  attribute UART_CLOCK_FREQUENCY of U0 : label is 160000000;
  ...
  attribute x_interface_parameter of clk_uart : signal is "XIL_INTERFACENAME ClockUART, ASSOCIATED_BUSIF UART, ASSOCIATED_RESET rst, FREQ_HZ 160000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN design_1_clk_wiz_0_1_clk_out1, INSERT_VIP 0";
