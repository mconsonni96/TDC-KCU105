...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Engine_AND_TC is
  ...
  attribute SOFT_HLUTNM of \din[19]_i_1\ : label is "soft_lutpair12";
...
\din[19]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Engine_EQ_TC_0 is
  port (
    ...
    clk_TDC : in STD_LOGIC;
    reset_TDC : in STD_LOGIC;
    CoarseCounter_CTD : in STD_LOGIC_VECTOR ( 1 downto 0 )
  );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Engine_EQ_TC_0 is
  signal CompOut_EQ_i_1_n_0 : STD_LOGIC;
begin
CompOut_EQ_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
      I0 => CoarseCounter_CTD(0),
      I1 => CoarseCounter_CTD(1),
      O => CompOut_EQ_i_1_n_0
    );
CompOut_EQ_reg: unisim.vcomponents.FDCE
     port map (
      C => clk_TDC,
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Step_TC is
  port (
    ...
    CoarseCounter_CTD : in STD_LOGIC_VECTOR ( 5 downto 0 );
    clk_TDC : in STD_LOGIC;
    reset_TDC : in STD_LOGIC
  );
...
\GEN_first_step.Gen_EQ[1].Inst_Engine\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Engine_EQ_TC_0
     port map (
      CoarseCounter_CTD(1 downto 0) => CoarseCounter_CTD(5 downto 4),
...
\Gen_Step_TC[0].Gen_step_EQ.Inst_Step_TC\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Step_TC
     port map (
      CoarseCounter_CTD(5 downto 0) => CoarseCounter_CTD(5 downto 0),
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_FIFO_Synchronizer is
  ...
  attribute READ_DATA_WIDTH : integer;
  attribute READ_DATA_WIDTH of Inst_xpm_fifo_async : label is 21;
  attribute READ_MODE : string;
  ...
  attribute WRITE_DATA_WIDTH : integer;
  attribute WRITE_DATA_WIDTH of Inst_xpm_fifo_async : label is 21;
  attribute WR_DATA_COUNT_WIDTH : integer;
  ...
  attribute SOFT_HLUTNM of \uncalib_tdata[19]_i_2\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \uncalib_tdata_tmp[19]_i_1\ : label is "soft_lutpair10";
...
\uncalib_tdata[19]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\uncalib_tdata_tmp[19]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0080"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_CoarseExtensionCore is
  port (
    ...
    m00_axis_uncalib_tdata : out STD_LOGIC_VECTOR ( 19 downto 0 );
    CoarseCounter_CTD : in STD_LOGIC_VECTOR ( 5 downto 0 );
    clk_TDC : in STD_LOGIC;
    clk_SYS : in STD_LOGIC;
    reset_SYS : in STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_CoarseExtensionCore is
  signal Inst_FIFO_Synchronizer_n_23 : STD_LOGIC;
  ...
  signal \uncalib_tdata[17]_i_2_n_0\ : STD_LOGIC;
  signal \uncalib_tdata[18]_i_1_n_0\ : STD_LOGIC;
  signal \uncalib_tdata[19]_i_1_n_0\ : STD_LOGIC;
  signal \uncalib_tdata[19]_i_3_n_0\ : STD_LOGIC;
  ...
  signal uncalib_tdata_tmp : STD_LOGIC_VECTOR ( 19 downto 0 );
  ...
  attribute SOFT_HLUTNM of \uncalib_tdata[17]_i_2\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \uncalib_tdata[19]_i_3\ : label is "soft_lutpair13";
...
Inst_FIFO_Synchronizer: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_FIFO_Synchronizer
     port map (
      ...
      dout(20 downto 0) => dout(20 downto 0),
      queue_reg => Inst_FIFO_Synchronizer_n_23,
      queue_reg_0 => Inst_FIFO_Synchronizer_n_25,
...
Inst_TreeComparator: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_TreeComparator
     port map (
      ...
      clk_TDC => clk_TDC,
      din(0) => \din_reg_n_0_[19]\,
      \din_reg[19]\ => Inst_TreeComparator_n_1,
      reset_TDC => reset_TDC,
      s00_axis_subint_tvalid => s00_axis_subint_tvalid
    );
...
\uncalib_tdata[17]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0000FF20"
    )
        port map (
...
\uncalib_tdata[17]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
      ...
      I1 => queue_reg_n_0,
      I2 => dout(18),
      O => \uncalib_tdata[17]_i_2_n_0\
    );
\uncalib_tdata[18]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAAAAAFFFF2E2A"
    )
        port map (
      I0 => \^m00_axis_uncalib_tdata\(18),
      I1 => data_valid,
      I2 => dout(19),
      I3 => dout(12),
      I4 => queue_reg_n_0,
...
\uncalib_tdata[19]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => dout(20),
      I4 => \uncalib_tdata[19]_i_3_n_0\,
      I5 => \^m00_axis_uncalib_tdata\(19),
      O => \uncalib_tdata[19]_i_1_n_0\
    );
\uncalib_tdata[19]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0000FFA8"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXI4Stream_CoarseExtensionCore is
  ...
  attribute BIT_COARSE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXI4Stream_CoarseExtensionCore : entity is 6;
