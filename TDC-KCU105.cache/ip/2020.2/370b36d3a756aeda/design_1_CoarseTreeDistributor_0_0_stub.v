...
/* synthesis syn_black_box black_box_pad_pin="reset,clk,CoarseCounter_CTD_0[5:0],CoarseCounter_CTD_1[5:0],CoarseCounter_CTD_2[5:0]" */;
  input reset;
  input clk;
  output [5:0]CoarseCounter_CTD_0;
  output [5:0]CoarseCounter_CTD_1;
  output [5:0]CoarseCounter_CTD_2;
endmodule
