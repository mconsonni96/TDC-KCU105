...
-- Date        : Mon Feb  7 17:12:17 2022
-- Host        : mconsonni-All-Series running 64-bit Ubuntu 20.04.3 LTS
-- Command     : write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ design_1_AXI4Stream_OverflowC_0_0_sim_netlist.vhdl
-- Design      : design_1_AXI4Stream_OverflowC_0_0
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_OverflowCounter is
  port (
    ...
    m00_axis_beltbus_tdata : out STD_LOGIC_VECTOR ( 24 downto 0 );
    clk : in STD_LOGIC;
    reset : in STD_LOGIC;
    s00_axis_timestamp_tdata : in STD_LOGIC_VECTOR ( 24 downto 0 );
...
begin
\CoarseOverflow_cnt_out[0]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\beltbus_tdata[10]_i_1\: unisim.vcomponents.LUT4
    generic map(
      ...
      I1 => s00_axis_timestamp_tdata(24),
      I2 => IsCalibrated,
      I3 => s00_axis_timestamp_tdata(10),
      O => p_0_in(10)
    );
\beltbus_tdata[11]_i_1\: unisim.vcomponents.LUT4
    generic map(
      ...
      I1 => s00_axis_timestamp_tdata(24),
      I2 => IsCalibrated,
      I3 => s00_axis_timestamp_tdata(11),
      O => p_0_in(11)
    );
\beltbus_tdata[12]_i_1\: unisim.vcomponents.LUT4
    generic map(
      ...
      I1 => s00_axis_timestamp_tdata(24),
      I2 => IsCalibrated,
      I3 => s00_axis_timestamp_tdata(12),
      O => p_0_in(12)
    );
\beltbus_tdata[13]_i_1\: unisim.vcomponents.LUT4
    generic map(
      ...
      I1 => s00_axis_timestamp_tdata(24),
      I2 => IsCalibrated,
      I3 => s00_axis_timestamp_tdata(13),
      O => p_0_in(13)
    );
\beltbus_tdata[14]_i_1\: unisim.vcomponents.LUT4
    generic map(
      ...
      I1 => s00_axis_timestamp_tdata(24),
      I2 => IsCalibrated,
      I3 => s00_axis_timestamp_tdata(14),
      O => p_0_in(14)
    );
\beltbus_tdata[15]_i_1\: unisim.vcomponents.LUT4
    generic map(
      ...
      I1 => s00_axis_timestamp_tdata(24),
      I2 => IsCalibrated,
      I3 => s00_axis_timestamp_tdata(15),
      O => p_0_in(15)
    );
\beltbus_tdata[16]_i_1\: unisim.vcomponents.LUT4
    generic map(
      ...
      I1 => s00_axis_timestamp_tdata(24),
      I2 => IsCalibrated,
      I3 => s00_axis_timestamp_tdata(16),
      O => p_0_in(16)
    );
\beltbus_tdata[17]_i_1\: unisim.vcomponents.LUT4
    generic map(
      ...
      I1 => s00_axis_timestamp_tdata(24),
      I2 => IsCalibrated,
      I3 => s00_axis_timestamp_tdata(17),
      O => p_0_in(17)
    );
\beltbus_tdata[18]_i_1\: unisim.vcomponents.LUT4
    generic map(
      ...
      I1 => s00_axis_timestamp_tdata(24),
      I2 => IsCalibrated,
      I3 => s00_axis_timestamp_tdata(18),
      O => p_0_in(18)
    );
\beltbus_tdata[19]_i_1\: unisim.vcomponents.LUT4
    generic map(
      ...
      I1 => s00_axis_timestamp_tdata(24),
      I2 => IsCalibrated,
      I3 => s00_axis_timestamp_tdata(19),
      O => p_0_in(19)
    );
...
\beltbus_tdata[20]_i_1\: unisim.vcomponents.LUT4
    generic map(
      ...
      I1 => s00_axis_timestamp_tdata(24),
      I2 => IsCalibrated,
      I3 => s00_axis_timestamp_tdata(20),
      O => p_0_in(20)
    );
\beltbus_tdata[21]_i_1\: unisim.vcomponents.LUT4
    generic map(
      ...
      I1 => s00_axis_timestamp_tdata(24),
      I2 => IsCalibrated,
      I3 => s00_axis_timestamp_tdata(21),
      O => p_0_in(21)
    );
\beltbus_tdata[22]_i_1\: unisim.vcomponents.LUT4
    generic map(
      ...
      I1 => s00_axis_timestamp_tdata(24),
      I2 => IsCalibrated,
      I3 => s00_axis_timestamp_tdata(22),
      O => p_0_in(22)
    );
...
\beltbus_tdata[24]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"00D0"
    )
        port map (
      I0 => s00_axis_timestamp_tdata(24),
      I1 => IsCalibrated,
...
beltbus_tvalid_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"D0"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXI4Stream_OverflowCounter is
  ...
  attribute BIT_COARSE_CEC of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXI4Stream_OverflowCounter : entity is 8;
  attribute BIT_FID : integer;
  attribute BIT_FID of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXI4Stream_OverflowCounter : entity is 1;
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute CHECK_LICENSE_TYPE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "design_1_AXI4Stream_OverflowC_0_0,AXI4Stream_OverflowCounter,{}";
