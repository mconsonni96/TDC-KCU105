...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_design_1_clk_wiz_0_1_clk_wiz is
  ...
  attribute BOX_TYPE of clkin2_ibufds : label is "PRIMITIVE";
  attribute CAPACITANCE of clkin2_ibufds : label is "DONT_CARE";
  attribute IBUF_DELAY_VALUE of clkin2_ibufds : label is "0";
  attribute IFD_DELAY_VALUE of clkin2_ibufds : label is "AUTO";
...
clkin2_ibufds: unisim.vcomponents.IBUFDS
    generic map(
      DIFF_TERM => false,
      IOSTANDARD => "DEFAULT"
    )
      ...
      I => clk_in2_p,
      IB => clk_in2_n,
      O => clk_in2_design_1_clk_wiz_0_1
    );
...
clkout3_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE"
        ...
        port map (
      CE => '1',
      I => clk_out3_design_1_clk_wiz_0_1,
      O => clk_out3
    );
mmcme3_adv_inst: unisim.vcomponents.MMCME3_ADV
    generic map(
      ...
      CLKIN2 => clk_in2_design_1_clk_wiz_0_1,
      CLKINSEL => clk_in_sel,
      ...
      CLKOUT2 => clk_out3_design_1_clk_wiz_0_1,
